...
<head>
    ...
    <title>RDV IT Solution - blog details</title>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="blog-details">
                                ...
                                <h2>Essential Tips for Data Backup and Recovery</h2>
                                <ul class="user">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-side">
                                ...
                                <div class="user-card">
                                    <div class="user-img">
                                        <img src="assets/images/blog/detailuser.png" alt="">
                                    </div>
                                    <h4>Michael Brown</h4>
                                    <p class="strem">IT Infrastructure Engineer</p>
                                    <p class="strem">Head of IT Operations</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="detail-slider">
                        <h3>Want To See More Related Content?</h3>

                        <div class="slider blog-slider1">
                            <div class="blog_item">
